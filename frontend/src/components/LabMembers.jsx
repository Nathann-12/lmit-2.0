        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
              {currentMembers.slice(0, visibleCount).map((member) => (
                <Card 
                  key={member.id} 
            ...
            {alumni.length > 0 && (
              <div className="mt-20 pt-12 border-t border-gray-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                  {alumni.slice(0, visibleAlumniCount).map(member => (
                    <div 
                      key={member.id} 
                      className="bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-lg p-4 flex flex-col transition-colors duration-200"
                    >
